...
for x in matches:
    try:
        ...
        update_time = pd.to_datetime(pd.read_html('https://www.maine.gov/dhhs/mecdc/infectious-disease/epi/airborne/coronavirus.shtml',
        ...
        if update_time > last_update_time:
            ...
            print('CDC '+str(list(shape_dict.values())[i]['filename'])+str(update_time)+'. Prior update was at: '+str(last_update_time))
            ...
            print('CDC '+str(list(shape_dict.values())[i]['filename'])+' not updated. Last updated: '+str(last_update_time)+'. Current CDC timestamp: '+str(update_time))
        i+=1
