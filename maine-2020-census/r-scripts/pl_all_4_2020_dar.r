...
# -----------------------------
header_file_path <- "../raw-data/me2020/megeo2020.pl"
part1_file_path  <- "../raw-data/me2020/me000012020.pl"
# part2_file_path  <- "../raw-data/me2020/me000022020.pl"
# part3_file_path  <- "../raw-data/me2020/me000032020.pl"

# -----------------------------
# Import the data
# -----------------------------
header_2020 <- read.delim(header_file_path, header=FALSE, colClasses="character", sep="|")
part1_2020  <- read.delim(part1_file_path,  header=FALSE, colClasses="character", sep="|")
...
# -----------------------------
colnames(header_2020) <- c("FILEID", "STUSAB", "SUMLEV", "GEOVAR", "GEOCOMP", "CHARITER", "CIFSN", "LOGRECNO", "GEOID", 
